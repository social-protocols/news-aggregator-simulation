...
object Data {
  ...
  // select sum(gain) as rankgain from dataset and topRank is not null group by topRank order by topRank;
  val voteGainOnTopRankCounts       = Array[Double](
    100481, 57457, 44419, 37889, 33027, 28484, 25084, 23950, 22680, 20959, 19343, 17739, 17320, 15863, 15862, 15325,
    15109, 14478, 14006, 13215, 12963, 12159, 11869, 11447, 11249, 10979, 10970, 10640, 10569, 10370, 6871, 5278, 4855,
    4199, 4232, 4028, 3920, 3646, 3411, 3573, 3251, 3242, 3240, 3027, 3129, 2913, 2611, 2616, 2521, 2548, 2408, 2452,
    2271, 2190, 2190, 2128, 2050, 2061, 1946, 1983, 1824, 1592, 1375, 1319, 1275, 1228, 1247, 1200, 1160, 1151, 1085,
    1115, 1022, 1022, 977, 949, 929, 933, 916, 961, 867, 910, 830, 859, 801, 843, 768, 863, 827, 971,
  )
